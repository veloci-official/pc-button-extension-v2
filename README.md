...
| ON-ON toggle Switch                | -                                  | 0.25€         | 2            | [Link](https://amzn.eu/d/gwfs0nj)      | It would make more sense to use ON-OFF switches but since the pictures will all have ON-ON switches I linked those.                                                                                                                                                      |
